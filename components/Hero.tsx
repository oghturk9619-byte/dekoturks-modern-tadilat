      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a href="#iletisim" className="group bg-deko-orange hover:bg-white hover:text-deko-navy text-white px-10 py-5 rounded-lg font-black text-lg uppercase tracking-wider transition-all shadow-2xl shadow-orange-600/30 flex items-center justify-center">
              Ücretsiz Teklif Al
              <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform" />
            </a>
            <button className="flex items-center justify-center space-x-4 text-white group cursor-not-allowed opacity-80" disabled>
